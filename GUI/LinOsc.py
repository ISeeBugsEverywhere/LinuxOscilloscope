...
class Ui_oscillWindow(object):
    def setupUi(self, oscillWindow):
        ...
        self.take_screenshot_btn.setMaximumSize(QtCore.QSize(220, 16777215))
        self.take_screenshot_btn.setObjectName("take_screenshot_btn")
        self.gridLayout_12.addWidget(self.take_screenshot_btn, 0, 0, 1, 2)
        ...
        self.gridLayout_12.addWidget(self.name_all_box, 1, 0, 1, 2)
        self.save_all_button = QtWidgets.QPushButton(self.groupBox_7)
        self.save_all_button.setMaximumSize(QtCore.QSize(220, 16777215))
        self.save_all_button.setObjectName("save_all_button")
        self.gridLayout_12.addWidget(self.save_all_button, 2, 0, 1, 2)
        ...
        self.memory_box.addItem("")
        self.memory_box.addItem("")
        self.gridLayout_12.addWidget(self.memory_box, 3, 0, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.help_button, 3, 1, 1, 1)
        spacerItem10 = QtWidgets.QSpacerItem(20, 370, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, oscillWindow):
        ...
        self.groupBox_7.setTitle(_translate("oscillWindow", "Screens/Memory"))
