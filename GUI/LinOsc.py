...
class Ui_oscillWindow(object):
    def setupUi(self, oscillWindow):
        ...
        spacerItem = QtWidgets.QSpacerItem(765, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_4.addWidget(self.ch1_comment, 3, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.ch2_comment, 4, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.ch3_comment, 5, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.ch4_comment, 6, 1, 1, 2)
        ...
        spacerItem13 = QtWidgets.QSpacerItem(419, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.outputBox = QtWidgets.QPlainTextEdit(self.groupBox_3)
        ...
        spacerItem14 = QtWidgets.QSpacerItem(20, 149, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem14, 2, 5, 1, 1)
        ...
        spacerItem15 = QtWidgets.QSpacerItem(857, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_11 = QtWidgets.QGridLayout(self.screeshotTab)
        ...
        self.gridLayout_11.addWidget(self.take_screenshot_btn, 0, 0, 1, 1)
        self.save_all_button = QtWidgets.QPushButton(self.screeshotTab)
        self.save_all_button.setObjectName("save_all_button")
        self.gridLayout_11.addWidget(self.save_all_button, 0, 1, 1, 1)
        self.name_all_box = QtWidgets.QLineEdit(self.screeshotTab)
        self.name_all_box.setObjectName("name_all_box")
        self.gridLayout_11.addWidget(self.name_all_box, 0, 2, 1, 1)
        self.memory_box = QtWidgets.QComboBox(self.screeshotTab)
        self.memory_box.setObjectName("memory_box")
        self.memory_box.addItem("")
        self.memory_box.addItem("")
        self.memory_box.addItem("")
        self.memory_box.addItem("")
        self.gridLayout_11.addWidget(self.memory_box, 0, 3, 1, 1)
        self.help_button = QtWidgets.QPushButton(self.screeshotTab)
        self.help_button.setMinimumSize(QtCore.QSize(32, 32))
        self.help_button.setMaximumSize(QtCore.QSize(32, 32))
        self.help_button.setObjectName("help_button")
        self.gridLayout_11.addWidget(self.help_button, 0, 4, 1, 1)
        self.groupBox_6 = QtWidgets.QGroupBox(self.screeshotTab)
        self.groupBox_6.setObjectName("groupBox_6")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.groupBox_6)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.webView = QtWebKitWidgets.QWebView(self.groupBox_6)
        self.webView.setUrl(QtCore.QUrl("about:blank"))
        self.webView.setObjectName("webView")
        self.gridLayout_9.addWidget(self.webView, 0, 0, 1, 1)
        self.gridLayout_11.addWidget(self.groupBox_6, 1, 0, 1, 5)
        spacerItem16 = QtWidgets.QSpacerItem(252, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_11.addItem(spacerItem16, 1, 5, 1, 1)
    ...
    def retranslateUi(self, oscillWindow):
        ...
        self.get_data_btn.setText(_translate("oscillWindow", "Get data from active channel(s)"))
        self.live_update_box.setText(_translate("oscillWindow", "Live update, every [s]:"))
        ...
        self.label_2.setText(_translate("oscillWindow", "CH1 comment"))
        self.label_3.setText(_translate("oscillWindow", "CH2 comment"))
        self.dir_btn.setText(_translate("oscillWindow", "Directory?"))
        self.label_8.setText(_translate("oscillWindow", "CH3 comment"))
        self.label_9.setText(_translate("oscillWindow", "CH4 comment"))
        ...
        self.save_all_button.setText(_translate("oscillWindow", "Save (ALL, *.csv)"))
        self.name_all_box.setPlaceholderText(_translate("oscillWindow", "name for a file?"))
        ...
        self.groupBox_6.setTitle(_translate("oscillWindow", "Help field"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.screeshotTab), _translate("oscillWindow", "Screenshots/Internal memory"))
