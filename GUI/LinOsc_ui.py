...
# Form implementation generated from reading ui file '/home/egis/PythonProjects/LinuxOscilloscope/GUI/LinOsc.ui'
#
...
class Ui_oscillWindow(object):
    def setupUi(self, oscillWindow):
        ...
        self.visaRadio = QtWidgets.QRadioButton(self.centralwidget)
        self.visaRadio.setObjectName("visaRadio")
        self.horizontalLayout.addWidget(self.visaRadio)
        self.visaCombo = QtWidgets.QComboBox(self.centralwidget)
        self.visaCombo.setObjectName("visaCombo")
        self.horizontalLayout.addWidget(self.visaCombo)
        ...
        self.gridLayout_4.addWidget(self.dir_btn, 1, 1, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.plusMButton, 3, 1, 1, 1)
        self.helpButton = QtWidgets.QPushButton(self.oscilloscopeTab)
        self.helpButton.setObjectName("helpButton")
        self.gridLayout_7.addWidget(self.helpButton, 8, 1, 1, 1)
        spacerItem7 = QtWidgets.QSpacerItem(20, 358, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout_7.addWidget(self.formulaEdit, 8, 0, 1, 1)
        self.clrButton = QtWidgets.QPushButton(self.oscilloscopeTab)
        self.clrButton.setObjectName("clrButton")
        self.gridLayout_7.addWidget(self.clrButton, 5, 1, 1, 1)
        self.commentField = QtWidgets.QLineEdit(self.oscilloscopeTab)
        self.commentField.setObjectName("commentField")
        self.gridLayout_7.addWidget(self.commentField, 0, 0, 1, 1)
        self.oscillographPlot = PlotWidget(self.oscilloscopeTab)
        self.oscillographPlot.setObjectName("oscillographPlot")
        self.gridLayout_7.addWidget(self.oscillographPlot, 1, 0, 7, 1)
        ...
        self.gridLayout_10.addItem(spacerItem11, 0, 4, 1, 1)
        ...
        spacerItem12 = QtWidgets.QSpacerItem(419, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem13 = QtWidgets.QSpacerItem(20, 149, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout_12.addItem(spacerItem14, 1, 1, 2, 1)
        ...
        spacerItem15 = QtWidgets.QSpacerItem(124, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_12.addItem(spacerItem15, 1, 3, 2, 1)
        ...
        spacerItem16 = QtWidgets.QSpacerItem(118, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_12.addItem(spacerItem16, 2, 5, 1, 2)
        ...
        self.menuTestavimas = QtWidgets.QMenu(self.menubar)
        self.menuTestavimas.setObjectName("menuTestavimas")
        ...
        self.actionDebug = QtWidgets.QAction(oscillWindow)
        self.actionDebug.setCheckable(True)
        self.actionDebug.setObjectName("actionDebug")
        self.menuFile.addAction(self.actionQuit_Ctrl_Q)
        self.menuTestavimas.addAction(self.actionDebug)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuTestavimas.menuAction())
    ...
    def retranslateUi(self, oscillWindow):
        ...
        self.visaRadio.setText(_translate("oscillWindow", "VISA?"))
...
"active channel(s)"))
        ...
        self.helpButton.setText(_translate("oscillWindow", "HELP?"))
        ...
        self.commentField.setPlaceholderText(_translate("oscillWindow", "Comments?"))
        ...
        self.menuTestavimas.setTitle(_translate("oscillWindow", "Testavimas"))
        self.actionQuit_Ctrl_Q.setText(_translate("oscillWindow", "&Quit(Ctrl+Q)"))
        self.actionDebug.setText(_translate("oscillWindow", "Debug?"))
